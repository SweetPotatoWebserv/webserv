...
TEST_SRC = $(addprefix $(TEST_DIR)/, test_main.cpp test_is_request_ready.cpp test_is_complete_transfer.cpp test_is_complete_content_length.cpp test_split.cpp test_trim.cpp test_search_header_field.cpp)
